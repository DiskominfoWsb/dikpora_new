                        ...
                        <div class="row mb-2 gx-1">
                            <div class="col-lg-4">
                                <select name="category" class="form-select" onchange="this.form.submit()">
                                    <option value="0">Kategori Informasi</option>
                                    <?php
                                        foreach($newsCats as $nc):
                                            $selected = (@$_GET['category'] == $nc['ID']) ? ' selected="selected"' : '';
                                            echo '<option value="'.$nc['ID'].'"'.$selected.'>'.$nc['name'].'</option>';
                                        endforeach;
                                    ?>
                                </select>
                            </div>
                            <div class="col-lg-8">
                                <div class="input-group">
                                    ...
                                    <button type="submit" name="filter" value="1" class="btn btn-sm btn-secondary rounded-end" id="button-search">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <small><?php echo date('d/m/Y', strtotime($post->last_modified)); ?></small>
                                    </td>
                                    <td class="text-center">
                                        <a href="<?php echo base_url('artikel/'.$post->slug); ?>" class="px-1 text-center a-normal rounded" title="Lihat">
                                            <i class="bi bi-eye"></i>
                                        </a>
                                    </td>
                                </tr>
