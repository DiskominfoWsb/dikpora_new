<div class="container">
    ...
    <div class="col-lg-12">
        <?php foreach ($imageFiles as $if) : ?>
            <div class="media-item d-inline-flex align-items-end justify-content-center border rounded bg-info" style="background-image: url('<?php echo site_url('upload/view?file=' . $if['name']); ?>');">
                <div class="media-item-title d-flex justify-content-center align-items-center bg-dark-op-50 rounded-bottom">
                    <div class="d-inline-flex">
                        ...
                        <a href="<?php echo site_url('upload/view?file=' . $if['name']); ?>" class="text-light ms-2 pt-1" role="button" data-magnify="gallery" title="Lihat">
                            <i class="bi bi-eye"></i>
                        </a>
                        <a href="javascript:void(0)" class="text-light ms-2 pt-1">
                            <i class="bi bi-link-45deg" title="Salin URL"></i>
                        </a>
                        <!-- <a href="<?php echo base_url('media'); ?>/delete?t=img&f=<?php echo $if['name'] . '&m=' . $if['name']; ?>" class="text-light ms-2 pt-1" title="Hapus" onclick="return confirm('Apakah Anda yakin?')">
